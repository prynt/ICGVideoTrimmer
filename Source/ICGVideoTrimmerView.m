...
- (void)resetSubviews
{
    ...
    CGFloat rightViewFrameX = CGRectGetWidth(self.frameView.frame) < CGRectGetWidth(self.frame) - self.thumbWidth ? CGRectGetWidth(self.frameView.frame) : CGRectGetWidth(self.frame) - self.thumbWidth;
